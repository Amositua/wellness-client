...
export default function LetterAvatars() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://equal-yoke-touted-vein-production.pipeops.app/api/hospital/profile/${id}`
      )
      .then((res) => {
    ...
    axios
      .post(
        `https://equal-yoke-touted-vein-production.pipeops.app/api/booking/all`,
        i
      )
      .then((res) => {
        if (res.status !== 200) return;
                  ...
                  >
                    <Button
                      onClick={() => {
                        axios
                          .post(
                            "https://equal-yoke-touted-vein-production.pipeops.app/api/booking/update",
                            {
                              id: v._id,
                              status: -1,
                            }
